...
@Composable
fun CorreoEnviadoExitoScreen(navController: NavHostController) {
    val idioma by IdiomaManager.idioma.collectAsState()

    val textos = mapOf(
        "descripcion_icono" to mapOf("es" to "Correo enviado", "en" to "Email sent"),
        "mensaje" to mapOf("es" to "¡Correo enviado con éxito!", "en" to "Email sent successfully!"),
